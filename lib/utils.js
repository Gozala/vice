...
function moveUp(env, count) {
  env.editor.selection.moveCursorBy(-1 * count, 0);
}
exports.moveUp = moveUp

function moveDown(env, count) {
  env.editor.selection.moveCursorBy(count, 0);
}
exports.moveDown = moveDown

function moveForward(env, count) {
  env.editor.selection.moveCursorBy(0, count)
}
exports.moveForward = moveForward

function moveBack(env, count) {
  env.editor.selection.moveCursorBy(0, -1 * count)
}
